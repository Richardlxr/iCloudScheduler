...
默认假设你写下的内容已经够了，尽量不让你回头补充。没有写具体时刻时，模型只判断原文的说法属于哪一种——尽快、今天、明天、后天、某个星期几、周末、本周、下周、月底，再加上早上/上午/中午/下午/晚上——具体时刻由本机按提交时间换算。“明天下午交材料”落在明天 15:00，“周三晚上开会”落在最近的周三 20:00，模型不做日期推算，也不会因此追问。确认窗口写明“原文只写了‘明天下午’：已安排在 9月23日 周三 15:00 提醒”，可直接改。同一条消息里点名多人时合并为一条日程，人名写入备注。

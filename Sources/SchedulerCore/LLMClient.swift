...
public struct LLMClient: Sendable {
    ...
    public static func extractionPrompt(now: Date, timeZone: String, reminder: Int) -> String {
        ...
        示例五（改期）：referenceNow=2026-09-12T18:00:00，输入“原定明天下午的组会改到周四下午三点”应输出：
        {"events":[{"title":"组会","kind":"event","action":"update","targetTitle":"组会","targetStartLocal":"2026-09-13","startLocal":"2026-09-17T15:00:00","endLocal":null,"timeZone":"Asia/Shanghai","allDay":false,"location":"","notes":"","reminderMinutes":15,"extraReminderMinutes":[],"dueDay":null,"dayPart":null,"lunarDate":null,"isDeadline":false,"repeatRule":null,"repeatDays":[],"repeatUntil":null,"repeatCount":null,"missing":[],"assumptions":[],"source":"原定明天下午的组会改到周四下午三点"}],"questions":[]}
        示例六（取消）：输入“明天的班会取消了”应输出：
        {"events":[{"title":"班会","kind":"event","action":"cancel","targetTitle":"班会","targetStartLocal":"2026-09-13","startLocal":null,"endLocal":null,"timeZone":"Asia/Shanghai","allDay":false,"location":"","notes":"","reminderMinutes":null,"extraReminderMinutes":[],"dueDay":null,"dayPart":null,"lunarDate":null,"isDeadline":false,"repeatRule":null,"repeatDays":[],"repeatUntil":null,"repeatCount":null,"missing":[],"assumptions":[],"source":"明天的班会取消了"}],"questions":[]}
